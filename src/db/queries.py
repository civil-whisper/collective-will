...
async def create_policy_candidate(
    ...
    candidate = PolicyCandidate(
        ...
        action_mechanism=data.action_mechanism,
...
async def create_cluster(session: AsyncSession, data: ClusterCreate) -> Cluster:
    cluster = Cluster(
        ...
        refinement_draft=data.refinement_draft,
        refinement_draft_fa=data.refinement_draft_fa,
        refinement_confidence=data.refinement_confidence,
        refinement_requires_clarification=data.refinement_requires_clarification,
        refinement_notes=data.refinement_notes,
